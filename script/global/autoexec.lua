...
--	end
	...
	if tonumber(date("%y%m%d")) >= 161105 and tonumber(date("%y%m%d")) <= 161125 then
	...
	--SendScript2VM("\\script\\function\\vip_card\\ac_head.lua", "ac_RegisterEvents()"); --×¢²á»î¶¯¿¨ÊÂ¼þ
	AddJDYYNpc(); --Ìí¼Ó½£µ´ÑàÔÆNPC
end;
...
function Addcangjian()
    ...
    CreateNpcList({
		{"V­¬ng An Th¹ch", "Sø gi¶ Tµng KiÕm", 300,1776,3703, "\\script\\²Ø½£É½×¯\\task_script\\³É¶¼\\²Ø½£Ê¹Õß.lua"},
		{"V­¬ng An Th¹ch", "Sø gi¶ Tµng KiÕm", 200,1229,2762, "\\script\\²Ø½£É½×¯\\task_script\\ãê¾©\\²Ø½£Ê¹Õß.lua"},
		{"V­¬ng An Th¹ch", "Sø gi¶ Tµng KiÕm", 100,1510,3106, "\\script\\²Ø½£É½×¯\\task_script\\ÈªÖÝ\\²Ø½£Ê¹Õß.lua"},
		{"V­¬ng An Th¹ch", "Sø gi¶ Tµng KiÕm", 350,1395,2851, "\\script\\²Ø½£É½×¯\\task_script\\ÏåÑô\\²Ø½£Ê¹Õß.lua"},
		{"V­¬ng An Th¹ch", "Sø gi¶ Tµng KiÕm", 150,1745,3119, "\\script\\²Ø½£É½×¯\\task_script\\ÑïÖÝ\\²Ø½£Ê¹Õß.lua"},
--		{"½­ºþ¿¡½Ü", "²Ø½£½£Ù×", 100,1504,3104, "\\script\\missions\\cangjianshanzhuang\\jt_npc.lua"},
--		{"½­ºþ¿¡½Ü", "²Ø½£½£Ù×", 200,1235,2764, "\\script\\missions\\cangjianshanzhuang\\jt_npc.lua"},
--		{"½­ºþ¿¡½Ü", "²Ø½£½£Ù×", 300,1770,3697, "\\script\\missions\\cangjianshanzhuang\\jt_npc.lua"},
	});
end
...
function ZgcNpcCreate()
	...
	for i = 1, getn(zgc_npc_inf) do
		...
		CreateNpcList({
			--Ã÷½ÌÏà¹Ø
			{"Ph­¬ng L¹p","Ph­¬ng L¹p",152,1452,3008,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\·½À°.lua"},
			{"HÇu §«n","HÇu §«n",152,1508,2956,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\ºî¶Ü.lua"},
			{"V­¬ng DÇn","V­¬ng DÇn",152,1560,3025,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\ÍõÒú.lua"},
			-- {"Ê¯±¦","Ê¯±¦",152,1349,2870,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\Ê¯±¦.lua"},
			{"T­ Hµnh Ph­¬ng","T­ Hµnh Ph­¬ng",152,1455,3132,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\Ë¾ÐÐ·½.lua"},
			{"§Æng Nguyªn GÝ¸c","§Æng Nguyªn GÝ¸c",152,1284,2748,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\µËÔª¾õ.lua"},
			{"LÖ Thiªn NhuËn","LÖ Thiªn NhuËn",152,1397,3059,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\À÷ÌìÈò.lua"},
			{"Ph­¬ng ThÊt PhËt","Ph­¬ng ThÊt PhËt",152,1480,3038,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\·½Æß·ð.lua"},
			{"Ph­¬ng B¸ch Hoa","Ph­¬ng B¸ch Hoa",152,1686,3284,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\·½°Ù»¨.lua"},
			{"Ph­¬ng B¸ch Hoa","Qu¸ ¶i hé tèng nh©n",3109,1605,3180,"\\script\\task\\practice\\³ö¹Ø´«ËÍÈË.lua"},
			{"R­¬ng ®å Trung Nguyªn","Thñ khè",152,1508,3074,"\\script\\½­ÄÏÇø\\Ã÷½Ì\\npc\\ÎïÆ·±£¹ÜÈË.lua"},
			--´äÑÌÏà¹Ø
...
function AddXiBei()
	...
	--·ïÏè¸®¸®
	--Ö÷ÏßÈÎÎñ&ÆäËûNpc
		{"¤ng giµ ph­¬ng B¾c2", "DiÖp L·o", 500,1808,3125, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Ò¶ÀÏ.lua"},
		{"Tr­¬ng Tr¹ch §oan", "¢u D­¬ng Häa ", 500,1727,3262, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Å·Ñô»­.lua"},
		{"Th­¬ng nh©n Ba T­", "Th­¬ng nh©n Ba T­", 500,1686,3252, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\²¨Ë¹ÉÌÈË.lua"},
		{"KÑo hå l«", "§­êng Hå L«", 500,1675,3168, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÌÆºùÂ«.lua"},
		{"Gi¸o chñ Minh Gi¸o", "T­ M· Minh Phong", 500,1600,3157, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Ë¾ÂíÃù·ç.lua"},
		{"Du Ph­¬ng ®¹i phu", "T«n Ph­¬ng Nh©n ", 500,1807,3045, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Ëï·½ÈÊ.lua"},
		{"§­êng M«n T©n m«n nh©n", "LiÔu Tïng V©n ", 500,1717,2986, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Áø×ÝÔÆ.lua"},
		{"Nam nh©n ph­¬ng B¾c3", "Th¸c B¹t Ho»ng ", 500,1808,2994, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÍØ°Îºë.lua"},
		{"Chñ qu¶n Háa KhÝ phßng", "§­êng Thiªn Thiªn", 500,1768,3256, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÌÆÜ·Ü·.lua"},
	--Ö°ÄÜNpc
		{"Thî rÌn Thæ Phån", "Chñ TiÖm vò khÝ", 500,1747,3092, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÎäÆ÷µêÀÏ°å.lua"},
		{"Chñ tiÖm vò khÝ Thæ Phån", "Chñ TiÖm Nam phôc", 500,1739,3098, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÄÐ×°µêÀÏ°å.lua"},
		{"Chñ tiÖm v¶i", "Chñ TiÖm N÷ phôc", 500,1701,3114, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Å®×°µêÀÏ°å.lua"},
		{"Chñ cÇm ®å Thæ Phån", "Chñ T¹p hãa", 500,1730,3109, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÔÓ»õµêÀÏ°å.lua"},
		{"Chñ tiÖm ®¸ Thæ Phån", "Chñ Kim hoµn", 500,1721,3115, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÊÎÆ·µêÀÏ°å.lua"},
		{"Ch­ëng d­îc Thæ Phån", "Chñ D­îc ®iÕm", 500,1763,3091, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\Ò©µêÀÏ°å.lua"},
		{"Chñ cÇm ®å Thæ Phån", "Chñ töu lÇu", 500,1700,3176, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\¾ÆÂ¥ÀÏ°å.lua"},
		{"Tr×nh Di", "Chñ th­¬ng héi", 500,1772,3186, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÉÌ»áÀÏ°å.lua"},
		{"Quan viªn", "Phông T­êng phñTh¸i thó ", 500,1886,3102, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\·ïÏè¸®Ì«ÊØ.lua"},
		{"Lôc PhiÕn cao thñ1", "Bé ®Çu", 500,1893,3114, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\²¶Í·.lua"},
		{"Vâ L©m Minh Chñ1", "Sø gi¶ m«n ph¸i", 500,1751,3141, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÃÅÅÉ½ÓÒýÈË.lua"},
	--¸®±±³µ·ò
		{"Xa phu", "Xa phu Phông T­êng", 500,1849,3061, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\·ïÏè³µ·ò.lua"},
	--¶«ÃÅ³µ·ò
		{"Xa phu", "Xa phu Phông T­êng", 500,1803,3220, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\·ïÏè³µ·ò.lua"},
	--Î÷ÃÅ³µ·ò
		{"Xa phu", "Xa phu Phông T­êng", 500,1671,3089, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\·ïÏè³µ·ò.lua"},
	--ÄÏÃÅ³µ·ò
		{"Xa phu", "Xa phu Phông T­êng", 500,1671,3202, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\·ïÏè³µ·ò.lua"},
	--±±ÃÅÏä×Ó
		{"R­¬ng ®å Tr.Nguyªn", "Thñ khè", 500,1828,3048, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÎïÆ·±£¹ÜÈË±±.lua"},
	--¶«ÃÅÏä×Ó
		{"R­¬ng ®å Tr.Nguyªn", "Thñ khè", 500,1798,3216, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÎïÆ·±£¹ÜÈË¶«.lua"},
	--Î÷ÃÅÏä×Ó
		{"R­¬ng ®å Tr.Nguyªn", "Thñ khè", 500,1678,3095, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÎïÆ·±£¹ÜÈËÎ÷.lua"},
	--ÄÏÃÅÏä×Ó
		{"R­¬ng ®å Tr.Nguyªn", "Thñ khè", 500,1656,3214, "\\script\\Î÷±±Çø\\·ïÏè¸®\\npc\\ÎïÆ·±£¹ÜÈËÄÏ.lua"},
	--ÁúÃÅÕò
		{"TiÓu nhÞ Thæ Phån", "TiÓu nhÞ", 507,1660,3293, "\\script\\Î÷±±Çø\\ÁúÃÅÕò\\npc\\µêÐ¡¶þ.lua"},
		{"ThiÕu niªn nam1", "T«n NhÞ Liªn", 507,1649,3293, "\\script\\Î÷±±Çø\\ÁúÃÅÕò\\npc\\Ëï¶þçö.lua"},
		{"Xa Lu©n B¸ V­¬ng", "Xa Lu©n B¸ V­¬ng", 507,1791,3173, "\\script\\Î÷±±Çø\\ÁúÃÅÕò\\npc\\³µÂÖ°ÔÍõ.lua"},
		{"Xu©n ThËp Tam n­¬ng", "Xu©n ThËp Tam n­¬ng", 507,1884,3317, "\\script\\Î÷±±Çø\\ÁúÃÅÕò\\npc\\´ºÊ®ÈýÄï.lua"},
	--À¥ÂØ
		{"Chu BÊt HoÆc", "Chu BÊt HoÆc", 509,1597,3203, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÖÜ²»»ó.lua"},
		{"TÇn BÊt Tri", "TÇn BÊt Tri", 509,1578,3194, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÇØ²»ÖÇ.lua"},
		{"TrÇn BÊt Vi", "TrÇn BÊt Vi", 509,1536,3228, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\³Â²»Îª.lua"},
		{"M· BÊt TiÒn", "M· BÊt TiÒn", 509,1581,3249, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\Âí²»Ç°.lua"},
		{"V­¬ng BÊt Phµm", "V­¬ng BÊt Phµm", 509,1427,3443, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\Íõ²»·².lua"},
		{"C«n L«n T©n Phã Ch­ëng M«n", "Mai BÊt Dung",509,1561,3270, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\Ã·²»ÈÝ.lua"},
		{"C«n Lu©n Nam ®Ö tö", "DiÖp Tö Thu", 509,1551,3214, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\Ò¶×ÓÇï.lua"},
		{"C«n Lu©n Nam ®Ö tö", "TriÖu Tö B×nh", 509,1432,3305, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÕÔ×ÓÆ½.lua"},
--		{"V©n Hi Hßa", "V©n Hi Hßa", 509,1615,3213, "\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÔÆôËºÍ.lua"},
--		{"Väng Th­ KiÕm", "Väng Th­ KiÕm", 509,1620,3211, },
--		{"V©n Väng Th­", "V©n Väng Th­", 509,1618,3160, },
		{"R­¬ng ®å Trung Nguyªn","Thñ khè",509,1600,3229,"\\script\\Î÷±±Çø\\À¥ÂØ\\npc\\ÎïÆ·±£¹ÜÈË.lua"},
	--ÌÆÃÅÈÎÏÀ£¨Â·¹ý£©
--		{"ÌÆÅªÔÂ", "ÌÆÅªÔÂ", 305,1538,2795, "\\script\\ÖÐÔ­¶þÇø\\ÌÆÃÅ\\npc\\ÌÆÅªÔÂ.lua"},
	--¹âÃ÷¶¥
		{"Hé ph¸p Minh Gi¸o", "¢n Minh ", 508,1691,2962, "\\script\\Î÷±±Çø\\¹âÃ÷¶¥\\npc\\ÒóÃú.lua"},
		{"Di Tu kh¸ch", "Di Tu §¹i h¸n", 508,1792,3306, "\\script\\Î÷±±Çø\\¹âÃ÷¶¥\\npc\\ò°Ðë´óºº.lua"},
	--¹ÅÑô¶´Ò»²ã
		{"Phi Th­êng §¹o nh©n", "Phi Th­êng §¹o nh©n", 511,1702,3365, "\\script\\Î÷±±Çø\\¹ÅÑô¶´Ò»²ã\\npc\\·Ç³£µÀÈË.lua"},
		{"C«n Lu©n Nam ®Ö tö", "§Ö Tö C«n L«n", 512,2061,3404, "\\script\\missions\\northwest_mission\\npc\\npc_log_in.lua"},
	--Ò©Íõ¹È
		{"ThiÕu niªn trong th«n", "L­u Tam ", 505,1482,2996, "\\script\\Î÷±±Çø\\Ò©Íõ¹È\\npc\\ÁõÈý.lua"},
		{"T©y H¹ Ph¸p v­¬ng", "T©y H¹ Ph¸p v­¬ng", 505,1538,3146, "\\script\\Î÷±±Çø\\Ò©Íõ¹È\\npc\\Î÷ÏÄ·¨Íõ.lua"},
	--É³Ä®ÃÔ¹¬
		{"Ngò Hµnh TrËn Sø", "Ngò Hµnh TrËn Sø", 506,1325,2715, "\\script\\missions\\northwest_mission\\npc\\npc_log_in.lua"},
		{"§éc Hµnh l·o xµ", "§éc Hµnh l·o xµ", 506,1545,2958, "\\script\\Î÷±±Çø\\É³Ä®ÃÔ¹¬\\npc\\¶ÀÐÐÀÏÍÓ.lua"},
		{"Nam nh©n T©y B¾c", "B¹ch Thiªn Thµnh", 506,1552,2665,"\\script\\Î÷±±Çø\\É³Ä®ÃÔ¹¬\\npc\\°×Ìì³É.lua"},
	--Ò©Íõ¹È
		{"D­îc thÊt thñ vÖ","D­îc thÊt thñ vÖ", 510,1571,2856, "\\script\\Î÷±±Çø\\Ò©Íõ¶´\\npc\\Ò©ÊÒ¿´ÊØÈË.lua"},
	--ÇØÊ¼»ÊÁê
		{"§éc tý", "§o¹n Tý", 503,1412,2742, "\\script\\Î÷±±Çø\\ÇØÊ¼»ÊÁê\\npc\\¶Ï±Û.lua"},
		{"L×a ch©n", "L×a ch©n", 503,1588,2976, "\\script\\Î÷±±Çø\\ÇØÊ¼»ÊÁê\\npc\\²ÐÍÈ.lua"},
	--»ÊÁêÒ»²ã
		{"Tr¶o V­¬ng", "Tr¶o V­¬ng", 513,1464,2998, "\\script\\Î÷±±Çø\\»ÊÁêÄ¹ÊÒÒ»²ã\\npc\\×¦Íõ.lua"},
		{"Thñ mé nh©n", "Thñ mé nh©n", 513,1591,3178, "\\script\\missions\\northwest_mission\\npc\\npc_log_in.lua"},
	--»ÊÁê¶þ²ã
		{"TrÊn mé l·nh qu©n", "T©y TrÊn mé T­íng qu©n", 514,1475,2977, "\\script\\Î÷±±Çø\\»ÊÁêÄ¹ÊÒ¶þ²ã\\npc\\ÕòÄ¹½«¾üÎ÷.lua"},
		{"TrÊn mé l·nh qu©n", "B¾c TrÊn mé T­íng qu©n", 514,1624,2822, "\\script\\Î÷±±Çø\\»ÊÁêÄ¹ÊÒ¶þ²ã\\npc\\ÕòÄ¹½«¾ü±±.lua"},
		{"TrÊn mé l·nh qu©n", "§«ng TrÊn mé T­íng qu©n", 514,1803,2983, "\\script\\Î÷±±Çø\\»ÊÁêÄ¹ÊÒ¶þ²ã\\npc\\ÕòÄ¹½«¾ü¶«.lua"},
		{"TrÊn mé l·nh qu©n", "Nam TrÊn mé T­íng qu©n", 514,1629,3169, "\\script\\Î÷±±Çø\\»ÊÁêÄ¹ÊÒ¶þ²ã\\npc\\ÕòÄ¹½«¾üÄÏ.lua"},
	--¹íÃÅ»ØÀÈ
		{"C«n Lu©n Nam ®Ö tö", "§Ö Tö C«n L«n", 328,1711,3258, "\\script\\ÖÐÔ­¶þÇø\\¹íÃÅ»ØÀÈ\\npc\\À¥ÂØµÜ×Ó.lua"},
	--ÌìÊ¦ÃØ¾³
		{"C«n Lu©n Nam ®Ö tö", "§Ö Tö C«n L«n", 329,1731,3429, "\\script\\ÖÐÔ­¶þÇø\\ÌìÊ¦ÃØ¾³\\npc\\À¥ÂØµÜ×Ó.lua"},
		{"C« L©u v­¬ng", "C« L©u v­¬ng", 329,1620,3354, "\\script\\ÖÐÔ­¶þÇø\\ÌìÊ¦ÃØ¾³\\npc\\÷¼÷ÃÍõ.lua"},
	});
...
function Add67EventNpcs()
	...
	--´´½¨¸´Ô­ÕæÈËNPC
		...
		SetNpcScript(npcIndex, "\\script\\online\\viet_event\\200907\\1\\npc_fuyuanzheren.lua");
		--´´½¨ÅÖÍÃ×ÓNPC
		local nSets1 = {{1558, 2754}, {1380, 2762}, {1397, 3095}, {1497, 3061}, {1457, 2876}};
		local nSets2 = {{1529, 3109}, {1584, 2917}, {1490, 2647}, {1388, 2694}, {1394, 2918}};
		local nSets3 = {{1664, 3427}, {1732, 3516}, {1874, 3275}, {2064, 3458}, {1783, 3699}};
		local nSets4 = {{1430, 2907}, {1499, 2903}, {1385, 3050}, {1441, 3078}, {1529, 3142}};
		local nSets5 = {{1688, 3086}, {1641, 3131}, {1686, 3189}, {1640, 3281}, {1721, 3274}};
		for i = 1, 5 do
			CreateNpc("Thá MËp", "Thá MËp", 151, nSets1[i][1], nSets1[i][2]);--ÔÆÃÎÔó
			CreateNpc("Thá MËp", "Thá MËp", 102, nSets2[i][1], nSets2[i][2]);--ÌÒ»¨µº
			CreateNpc("Thá MËp", "Thá MËp", 409, nSets3[i][1], nSets3[i][2]);--Ç§Ñ°ËþÒ»²ã
			CreateNpc("Thá MËp", "Thá MËp", 403, nSets4[i][1], nSets4[i][2]);--Î÷Ë«°æÄÉÄÏ²¿
			CreateNpc("Thá MËp", "Thá MËp", 116, nSets5[i][1], nSets5[i][2]);--ÍõÄ¸¶´Èý²ã
		end
	end
...
function shenghuotai_npc_create()
	SendScript2VM("\\script\\online\\olympic\\oly_head.lua", "oly_CreateShenghuoTan()")
end
...
--	ChangeNpcToFight(nNpcIdx, 0, 6);
	...
	CreateNpc("linjiacheng", "L©m Gia Thµnh-ng­êi giµu", 6300, 1342, 3121);
...
function AddJDYYNpc()
		tNpcs = {
			{"YÕn V©n Hoa Th¸nh L¹c Phi", "Hoa Th¸nh L¹c Phi", {300,1792,3565}, "\\script\\missions\\jiandangyanyun\\npcs\\luofei_npc.lua"},
		};
	for i = 1, getn(tNpcs) do
		if SubWorldID2Idx(tNpcs[i][3][1]) ~= -1 then
			local nIndex = CreateNpc(tNpcs[i][1], tNpcs[i][2], tNpcs[i][3][1], tNpcs[i][3][2], tNpcs[i][3][3]);
			...
			AddUnitStates(nIndex, 8, -GetUnitCurStates(nNpcIdx, 8));	--ÊÓÒ°±ä0
