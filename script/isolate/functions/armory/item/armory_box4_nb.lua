...
g_tRouteArmory = {
	...
	{1,	{"Quang Chiªu ƒm Kh¾c",	0,	115,	4001, "ƒm Kh¾c-Trang søc-"}},
}
...
function MakeArmory_Route(nSel, nStep, nValue)
	...
	if not nValue then
		local szMsg = format("<color=green>[%s]<color>: V¨n Søc l­u ph¸i chia lµm Thiªn V¨n, ChiÕn V¨n, HuyÒn V¨n, Minh §iªu, ƒm Kh¾c, kh«ng thÓ chän thuéc tÝnh ngò hµnh cña mçi c¸i, cïng t¹o thµnh 1 bé, mÆc 2 c¸i trë lªn sÏ cã thuéc tÝnh bé trang thªm so víi V¨n Søc th­êng.\n\n", tItem[1]);
		local tMenu = {
